...
export default function ChatWidget() {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
                        ...
                        <div className="p-4 border-b border-white/10 bg-white/5 flex justify-between items-center">
                            <div className="flex items-center gap-3">
                                <div className="relative w-10 h-10 flex-shrink-0">
                                    <div className="absolute inset-0 rounded-full bg-[var(--blue)] blur-[2px] opacity-70" />
                                    <div className="relative w-full h-full rounded-full p-[2px] bg-[var(--blue)]">
                        ...
                        >
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 bg-white/5 border border-white/10 rounded-full px-4 py-2 text-sm text-white focus:outline-none focus:border-[var(--blue)]/50 transition-colors disabled:opacity-50"
                                    disabled={isLoading}
            ...
            >
                {/* Glow Effect */}
                <div className="absolute inset-0 rounded-full bg-[var(--blue)] blur-md opacity-60 group-hover:opacity-100 transition-opacity duration-500" />
