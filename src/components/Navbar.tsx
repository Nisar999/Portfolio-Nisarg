                ...
                <div className="flex gap-8" role="list">
                    {navLinks.map((link) => (
                        <ScrollLink
                            ...
                            duration={500}
                            offset={-100}
                            className="text-sm font-medium text-white hover:text-[var(--blue)] cursor-pointer transition-colors relative group"
                            aria-label={`Navigate to ${link.name}`}
                            role="listitem"
                        >
                            {link.name}
                            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[var(--blue)] group-hover:w-full transition-all duration-300" />
                        </ScrollLink>
                    ))}
                </div>
            </div>
