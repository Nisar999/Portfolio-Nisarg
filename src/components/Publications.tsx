  ...
  return (
    <section className="py-24 max-w-4xl mx-auto px-6 relative">
        ...
        {publications.map((paper, i) => (
          ...
          >
            ...
            <div className="relative p-6 md:p-8 rounded-2xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.05] hover:border-[var(--blue)]/30 transition-all duration-300">
              {/* Decorative element */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[var(--blue)]/5 via-transparent to-[var(--purple)]/5 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-[var(--blue)]/5 to-[var(--purple)]/5 border border-white/10 backdrop-blur-sm"
      >
