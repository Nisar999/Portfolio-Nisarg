...
export default function Contact() {
  ...
  return (
    <section className="relative py-32 px-6 flex justify-center items-center overflow-hidden perspective-1000">
      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[var(--blue)]/15 blur-[120px] rounded-full pointer-events-none" />
          ...
          <div style={{ transform: "translateZ(50px)" }} className="relative z-30">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-12">
              <a
                ...
                className="group flex items-center gap-3 bg-[var(--blue)] text-white px-8 py-4 rounded-full font-medium text-lg hover:brightness-110 transition-all transform hover:scale-105 shadow-lg shadow-[0_0_24px_rgba(79,127,255,0.25)]"
